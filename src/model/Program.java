...
public class Program {
	...
	public String toString() {
		return String.format("%s; %s; %d-%d; %.2f; %.2f", getProgramName(), getUniversityName(), getGradeMin(), getGradeMax(), getTotalFee(), getMatchRating());
	}
	
	public String toString2() {
		return String.format("%s %s %s %s %d %d %.2f %s%n", getUniversityName(), getProgramName(), getInterestArea(), getCoursePrerequisites(), getGradeMin(), getGradeMax(), getTotalFee(), getLink());
	}
